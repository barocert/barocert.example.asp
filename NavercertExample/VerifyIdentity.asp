...
<%
    ...
    ' https://developers.barocert.com/reference/naver/asp/identity/api#VerifyIdentity
    '**************************************************************
    ...
    On Error Resume Next
        ...
        Dim result : Set result = m_NavercertService.VerifyIdentity(clientCode, receiptID)
