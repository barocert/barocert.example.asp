...
<%
	...
	' https://developers.barocert.com/reference/kakao/asp/cms/api#GetCMSStatus
	'**************************************************************
	...
	' 출금동의 요청시 반환된 접수아이디
	Dim receiptID : receiptID = "02312130230400000010000000000008"
	
	On Error Resume Next

	Dim result : Set result = m_KakaocertService.GetCMSStatus(clientCode, receiptID)
