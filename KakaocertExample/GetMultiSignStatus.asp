...
<%
	...
	' https://developers.barocert.com/reference/kakao/asp/sign/api-multi#GetMultiSignStatus
	'**************************************************************
	...
	' 전자서명 요청시 반환된 접수아이디
	Dim receiptID : receiptID = "02312130230400000010000000000007"
	
	On Error Resume Next

	Dim result : Set result = m_KakaocertService.GetMultiSignStatus(clientCode, receiptID)
	...
	<body>
		<div id="content">
			...
			<fieldset class="fieldset1">
				<legend>카카오 전자서명(복수) 상태확인</legend>
				<% If code = 0 Then %>
					<ul>
